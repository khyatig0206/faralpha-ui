    ...
    return (
      <div className="px-16 relative group">
        ...
        <div
          ...
          className="flex gap-6 overflow-x-auto pb-4 snap-x snap-mandatory no-scrollbar -mx-16 px-16 scroll-smooth"
        >
          {items.map((topic, idx) => (
  ...
  export default function Home() {
    ...
    return (
      <div className="min-h-screen bg-white font-sans">
        ...
        <div className="relative z-0 max-w-7xl mx-13 py-10 space-y-16 -mt-20">
